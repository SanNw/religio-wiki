-- Importado de https://pt.wikipedia.org/wiki/M%C3%B3dulo%3ACita%C3%A7%C3%A3o/CS1/COinS (Wikipédia em português, CC BY-SA 4.0).
local coins = {};
...
local function COinS(data, class)
	...
	if in_array (class, {'arxiv', 'citeseerx', 'journal', 'news'}) or (in_array (class, {'conference', 'interview', 'map', 'press release', 'web'}) and is_set(data.Periodical)) or 
		('citation' == class and is_set(data.Periodical) and not is_set (data.Encyclopedia)) then
			OCinSoutput.rft_val_fmt = "info:ofi/fmt:kev:mtx:journal";			-- journal metadata identifier
			if in_array (class, {'arxiv', 'citeseerx'}) then					-- set genre according to the type of citation template we are rendering											-- set genre according to the type of citation template we are rendering
				OCinSoutput["rft.genre"] = "preprint";							-- cite arxiv, cite citeseerx
