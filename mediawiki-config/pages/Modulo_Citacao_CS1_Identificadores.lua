-- Importado de https://pt.wikipedia.org/wiki/M%C3%B3dulo%3ACita%C3%A7%C3%A3o/CS1/Identificadores (Wikipédia em português, CC BY-SA 4.0).
local identifiers = {};
...
local function pmid(id)
    local test_limit = 40500000;                        -- update this value as PMIDs approach
...
local function pmc(id, embargo)
    local test_limit = 13900000;                            -- update this value as PMCs approach
